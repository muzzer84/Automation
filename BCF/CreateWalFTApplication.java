...
public class CreateWalFTApplication {

	WebDriver wd = null;

	public CreateWalFTApplication (WebDriver w) {
	...
	public void create() throws InterruptedException {
		...
		WebElement radio1 = wd.findElement(By.id("SFW")); 
		radio1.click();
		...
		act.sendKeys("Cardiff University").build().perform();
		Thread.sleep(2000);
		...
		act2.sendKeys("SIS-WAL-FT").build().perform();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		wd.findElement(By.xpath("//input[@name='hasKessTwoFunding' and @id='false']")).click();
		Thread.sleep(2000);
		wd.findElement(By.xpath("//*[@id=\"otherFundingSection\"]/div/div/div/form/div[5]/div/button[1]")).click();
		...
		wd.findElement(By.id("addresses[0]postcodeSearch")).sendKeys("CF10 2HE");
		wd.findElement(By.xpath("//*[@id=\"addresses[0]postcodeLookup\"]/button")).click();
		Thread.sleep(2000);
		
		JavascriptExecutor je5 = (JavascriptExecutor) wd;
		je5.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		Select drpAddress = new Select(wd.findElement(By.xpath("//*[@id=\"addresses[0]addressSelector\"]")));
		drpAddress.selectByVisibleText("Premier Inn");
		...
		wd.findElement(By.id("contactAddress0postcodeSearch")).sendKeys("CF10 2HE");
		...
		drpAddress2.selectByVisibleText("Premier Inn");
